      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section>
          <div className="py-10 mb-12 flex justify-between dark:text-white">
            <h1
              id="welcome"
              className="text-black dark:text-white font-glametrix italic text-4xl mt-20"
            >
              Bienvenue sur mon{" "}
          ...
          <div className="text-center py-10">
            ...
            <p className="text-lg py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-2xl mx-auto md:text-xl">
              {text.map((el, i) => (
                <motion.span
                  initial={{ opacity: 0.2 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.8, delay: i / 10 }}
                  key={i}
                >
                  {el}{" "}
                </motion.span>
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              <a
                href="https://www.linkedin.com/in/maylan-gomes-12093a302/"
                target="_blank"
              >
                <AiFillLinkedin />
              </a>
              <a
                href="https://github.com/maylangomes?tab=repositories"
                target="_blank"
              >
                <AiFillGithub />
              </a>
            ...
            <div className="mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 relative overflow-hidden mt-20 md:h-96 md:w-96">
              <Image
                src={
                  "https://raw.githubusercontent.com/maylangomes/Assets/main/photo_profil.png"
                }
                priority
                layout="fill"
                objectFit="cover"
