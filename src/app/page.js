...
export default function Home() {
  ...
  const text = "Étudiant à la Web@cadémie d'Epitech, je peux réaliser des projets sous tous leurs aspects dans de nombreux langages et framwork : PHP - Javascript - Typescript - SQL - PostgreSQL - SASS - Symfony - Laravel - React native - React.js - Next.js - jQuery - Supabase - Bootstrap - Tailwind CSS.".split(" ");
